...
SUBSCRIPTION_KEY = "{your api key}" #os.environ.get('SPEECH_KEY')
SERVICE_REGION = "{your region}" #os.environ.get('SPEECH_REGION')
    ...
    if job_id is not None:
        while True:
            ...
            if status['status'] == 'Succeeded':
                ...
                return status['outputs']['result'] # tts 파일 다운로드 url
